...
Ensure `ableton` CLI is installed and available in PATH:

```bash
# If using the project venv, activate it first:
# source <ableton-cli-repo>/.venv/bin/activate

# Or install globally:
# pip install ableton-cli
```
